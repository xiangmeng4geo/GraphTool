!function(){
	...
	function Interpolation_IDW_Neighbor(SCoords, lnglat_arr, NumberOfNearestNeighbors, unDefData, bCalAllGrids){
		console.time('Interpolation_IDW_Neighbor');
		var num4,num5;
		var length = lnglat_arr.length,	//获取X数组大小
			...
			objArray = [[],[]];
		console.log('Interpolation_IDW_Neighbor', 'dataLen = '+num3+', lnglatLen = '+ length*num);
		...
		console.timeEnd('Interpolation_IDW_Neighbor');
		return lnglat_arr;
	}
}()