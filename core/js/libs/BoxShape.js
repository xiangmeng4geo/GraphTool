define('BoxShape',
    function (require) {
        ...
        function Layer_LabelRect(options){
            var _this = this;
        ...
        var prop_Layer_LabelRect = Layer_LabelRect.prototype;
        prop_Layer_LabelRect.getArect = function(){
            return this.shape.getRect();
        }
        prop_Layer_LabelRect.modify = function(style){
            var _this = this;
        ...
        prop_Layer_LabelRect.destroy = function(){
            var _this = this;
        ...
        prop_Layer_LabelRect.setEditable = function(editable){
            var _this = this;
            var $html = _this.$html;
            if(editable){
                $html.css({
        ...
        function Layer_Ellipse(options){
            var _this = this;
            var $container = options.container;

            var zr = _zrender.init($container.get(0));
        ...
        var prop_Layer_Ellipse = Layer_Ellipse.prototype;
        prop_Layer_Ellipse.modify = function(style){
            var _this = this;
            var zr = _this.zr;
        ...
        prop_Layer_Ellipse.destroy = function(){
            this.zr.dispose();
        }
        return {
            "LabelRect": Layer_LabelRect,
