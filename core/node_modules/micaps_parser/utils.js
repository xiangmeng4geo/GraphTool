!function(G){
    var _isInsidePolygon = (function(){
        ...
        return function (vs, x, y, key_x, key_y) {
            key_x || (key_x = 'x');
            key_y || (key_y = 'y');
    ...
    /*多边形是否在另一个多边形里*/
    var _polygonIsInsidePolygon = function(polygon_items, sub_polygon_items, is_return_num, key_x, key_y){
        key_x || (key_x = 'x');
        key_y || (key_y = 'y');
        var inside_num = 0;
        sub_polygon_items.forEach(function(v){
            var flag = _isInsidePolygon(polygon_items, v[key_x], v[key_y], key_x, key_y);
            if(flag){
                inside_num++;
            }
        });
    ...
    //     this.utils = exports;
    // }
    G.isInsidePolygon = _isInsidePolygon;
    G.isInLeftTopLine = _isInLeftTopLine;
    G.lineIsInsidePolygon = _lineIsInsidePolygon;
    G.polygonIsInsidePolygon = _polygonIsInsidePolygon;

    G.Digit = Digit;
}(typeof __dirname === 'undefined'? (this.utils = {}): exports);